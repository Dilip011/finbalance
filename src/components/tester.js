...
const Signup = () => {
  ...
  const docrefer = () => {
    const docref = collection_ref.doc();
    ...
    <>
      <div>
        <div className='registration_box'>
          ...
          <input type="submit" value="Register" className='register_button' id='register_button' onClick={docrefer} style={{ padding: "16px 33px 17px 35px", margin: "7px 5px 5px 55px", border: '1px solid white', background: '#009879', border_radius: "16px", font_size: "19px" }} />
